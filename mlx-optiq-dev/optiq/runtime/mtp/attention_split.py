...
def _install_split_attention_hook(attn: Any) -> bool:
    ...
    def split_call(
        ...
        **kwargs: Any,
        ...
        # Pass any arch-specific extras (e.g. gemma-4's ``shared_kv``) straight
        # through to the original attention — the split path only kicks in for
        # gated-q_proj attentions that never carry these.
