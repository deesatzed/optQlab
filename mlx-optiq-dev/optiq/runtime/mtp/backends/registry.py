...
from optiq.runtime.mtp.profiles import DEFAULT_PROFILE_NAME, PROFILE_CHOICES, resolve_profile_name
...
class RuntimeContract:
    ...
    def from_dict(cls, data: dict[str, Any]) -> "RuntimeContract":
        ...
        if data.get("recommended_draft_lm_head") is not None:
            from optiq.runtime.mtp.draft_lm_head import normalize_draft_lm_head_spec
        ...
        if data.get("recommended_draft_sampler") is not None:
            from optiq.runtime.mtp.draft_sampling import normalize_draft_sampler_spec
