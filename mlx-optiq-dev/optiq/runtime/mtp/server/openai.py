...
from optiq.runtime.mtp.adaptive import AdaptiveDepthPolicy, ExpectedValueDepthPolicy
from optiq.runtime.mtp.attention_context import attention_phase
from optiq.runtime.mtp.cache_state import snapshot_cache
from optiq.runtime.mtp.mtp_patch import MTPContract
from optiq.runtime.mtp.model_scheduler import ModelWorkScheduler
...
from optiq.runtime.mtp.server_urls import bind_label, is_wildcard_bind, local_url_for_bind

try:
    from optiq.runtime.mtp.generation import (
        PostcommitAbort,
        generate_ar,
        generate_mtpk,
        restore_or_prefill_prompt_state,
    )
    from optiq.runtime.mtp.native_mlp import native_mlp_stats
    from optiq.runtime.mtp.engine_session import (
        EngineSessionBusy,
    ...
    from optiq.runtime.mtp.session_bank import CacheMissReason
...
def _open_pi_later(command: str, *, model_id: str, delay_s: float = 1.0) -> None:
    def open_pi() -> None:
        try:
            from optiq.runtime.mtp.pi import launch_pi_in_terminal, pi_model_ref
